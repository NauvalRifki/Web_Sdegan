...
class AdminController extends Controller {
    ...
    public function dataPangan(){
        ...
        return view('dashboard_admin.sub_menu.data_pangan', ['dataKomoditas' => $dataGabungan]);
    }
    ...
    public function saveData(Request $request) {
        ...
        if ($action === 'return') {
            return redirect()->route('dashboard_admin.sub_menu.data_pangan')
                ->with('success', 'Data berhasil dikembalikan ke halaman Data Pangan!');
        }
    ...
    public function updateStatusVerifikasi(Request $request, $id){
        ...
        return redirect()->route('dashboard_admin.sub_menu.verifikasi_data')->with('success', 'Status data berhasil diperbarui!');
    }    

    public function kembalikanData(Request $request){
        $dataList = $request->input('data');
        ...
        return redirect()->route('dashboard_admin.sub_menu.data_pangan')->with('success', 'Data berhasil dikembalikan ke halaman Data Pangan!');
    }    
