...
<body> 
    <div class="container">
        ...
        <form action="{{ route('dashboard_operator.data.bulkDelete') }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data yang dipilih?')">
            @csrf
                        ...
                        @forelse ($dataKomoditas as $data)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('dashboard_operator.data.edit', $data->id) }}" class="btn btn-edit btn-sm">
